...
Username = env_vars.get("Username")#env_vars.get("Username")
Assistantname = env_vars.get("Assistantname") #env_vars.get("Assistantname")
GroqAPIKey = env_vars.get("GroqAPIKey")

# Initialize the Groq client using the provided API key.
client = Groq(api_key="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") #GroqAPIKey
...
*** Do not provide notes in the output, just answer the question and never mention your training data. jg***
